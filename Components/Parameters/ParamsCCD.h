...
public:
	...
	ParamsCCD();
        virtual ~ParamsCCD();
        void     paramsCCDcalculation(DataSet &m_DataSet);
        void     paramsCCDresizeCCD(DataSet &m_DataSet);
        void     paramsCCDcheckCCDParams(DataSet &m_DataSet);
        void     paramsCCDmappingCCDParams();
        void     paramsCCDsubmappingCCDParams();
        void     paramsCCDPixelOffsetToRad();
        void     paramsCCDcomputeCCDOrientation();
        void     paramsCCDcomputeCCDOrientation(double raJitterAxis, double declJitterAxis, 
                                                double yaw, double pitch, double roll);
        void     paramsCCDcomputeRadiusFOVandCenter(); 
        void     paramsCCDgetTransformationCCDToSky(double xStarCCD, double yStarCCD, 

...
/**
 * This function calls all the functions required to perform the WUVS Preprocessing
 ...
 * @param m_DataSet
 */
void ParamsWUVS::ParamsWUVScalculation(DataSet &m_DataSet)
{
    //Pointing to the dataSet
    p_DataSet = &m_DataSet;
    
    // Get the WUVS parameters from the input parameters file.
    ...
    ParamsWUVS::ParamsWUVSresizeCCD(m_DataSet);
    
    //Check whether the input parameters are valid
    ParamsWUVS::ParamsWUVScheckCCDParams(m_DataSet);
    
    //Create a initial pixel map with the subfield size
    ParamsWUVS::ParamsWUVSmappingCCDParams();
    ParamsWUVS::ParamsWUVSsubmappingCCDParams();
    
    ParamsWUVS::ParamsWUVSPixelOffsetToRad();
    
    //Compute the orientation of the CCD without jitter
    ParamsWUVS::ParamsWUVScomputeCCDOrientation(0, 0, 0, 0, 0);
    ParamsWUVS::ParamsWUVScomputeRadiusFOVandCenter();
 ...
 */
void ParamsWUVS::ParamsWUVSresizeCCD(DataSet &m_DataSet)
{
 ...
 */
void ParamsWUVS::ParamsWUVScheckCCDParams(DataSet &m_DataSet)
{
 ...
 */
void ParamsWUVS::ParamsWUVSmappingCCDParams()
{
 ...
 */
void ParamsWUVS::ParamsWUVSsubmappingCCDParams()
{
 ...
 *
 */
void ParamsWUVS::ParamsWUVSPixelOffsetToRad()
{
 ...
 */
void ParamsWUVS::ParamsWUVScomputeCCDOrientation(double raJitterAxis, double declJitterAxis, double yaw, double pitch, double roll)
{
 ...
 */
void ParamsWUVS::ParamsWUVScomputeRadiusFOVandCenter()
{
	...
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(ccdSizeX / 2., ccdSizeY / 2., opticalAxisRACenter, opticalAxisDecCenter);
	...
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(0, 0, ra1, dec1);
	...
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(ccdSizeX, 0, ra1, dec1);
	fov0 = MathTools::getAngularDistanceSphere(opticalAxisRACenter * Constants::DEG2RAD, opticalAxisDecCenter * Constants::DEG2RAD, ra1
                                               * Constants::DEG2RAD, dec1 * Constants::DEG2RAD);
	if (fov0 > maxi)
		maxi = fov0;
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(0, ccdSizeY, ra1, dec1);
	fov0 = MathTools::getAngularDistanceSphere(opticalAxisRACenter * Constants::DEG2RAD, opticalAxisDecCenter * Constants::DEG2RAD, ra1
                                               * Constants::DEG2RAD, dec1 * Constants::DEG2RAD);
	if (fov0 > maxi)
		maxi = fov0;
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(ccdSizeX, ccdSizeY, ra1, dec1);
	fov0 = MathTools::getAngularDistanceSphere(opticalAxisRACenter * Constants::DEG2RAD, opticalAxisDecCenter * Constants::DEG2RAD, ra1
                                               * Constants::DEG2RAD, dec1 * Constants::DEG2RAD);
	if (fov0 > maxi)
		maxi = fov0;
	...
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(x, y, raCenterSubField, declCenterSubField);
	...
	//fov of sub-field
	double ra2, dec2;
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(edgePixels + subFieldZeroX, edgePixels + subFieldZeroY + subFieldSizeY / 2., ra1, dec1);
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(edgePixels + subFieldZeroX + subFieldSizeX, edgePixels + subFieldZeroY + subFieldSizeY / 2., ra2,
                                                  dec2);
	...
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(edgePixels + subFieldZeroX + subFieldSizeX / 2., edgePixels + subFieldZeroY, ra1, dec1);
	ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(edgePixels + subFieldZeroX + subFieldSizeX / 2., edgePixels + subFieldZeroY + subFieldSizeY, ra2,
                                                  dec2);
 ...
 */
void ParamsWUVS::ParamsWUVSgetTransformationCCDToSky(double xStarCCD, double yStarCCD, double &raS, double &decS)
{
